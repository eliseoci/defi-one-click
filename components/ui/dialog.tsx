...
function DialogContent({
  ...
  const variantClasses =
    variant === 'bottom-sheet'
      ? 'fixed inset-x-0 bottom-0 z-50 w-full max-w-none translate-x-0 translate-y-0 rounded-t-2xl border border-border/80 p-6 shadow-xl data-[state=open]:slide-in-from-bottom data-[state=closed]:slide-out-to-bottom'
