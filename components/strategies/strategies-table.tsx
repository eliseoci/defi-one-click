...
export function StrategiesTable({ strategies }: StrategiesTableProps) {
  ...
  return (
    <Card className="overflow-hidden">
      {/* Table Header */}
      <div className="grid grid-cols-[1fr_100px_100px_120px_100px_120px_80px] gap-4 p-4 border-b bg-muted/50 text-xs font-medium text-muted-foreground uppercase">
        <div>Strategy</div>
      ...
      <div className="divide-y">
        {strategies.map((strategy) => (
          <div
            key={strategy.id}
            className="grid grid-cols-[1fr_100px_100px_120px_100px_120px_80px] gap-4 p-4 hover:bg-muted/50 transition-colors cursor-pointer"
          >
            {/* Strategy Name & Info */}
